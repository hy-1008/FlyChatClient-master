...
public class Controller {
                    ...
                    if (resultSet.next()) {
                        if (resultSet.getString(3).equals(Password)) {
                            ...
                            if (set.next()) {
                                ...
                                //聊天助手
                                mainWindow.addFriend("system", "Fly Chat聊天助手","聊天助手");
                                ((Label) $(mainWindow, "Y_account")).setText("Fly Chat聊天助手");
                                MsgData.msg.add(new Vector<>());
                                MsgData.accountList.add("Fly Chat聊天助手");
                                MsgData.msgTip.put("Fly Chat聊天助手", 0);
                                //所有好友
                                ...
                                MsgData.msg.get(0).add("Fly Chat聊天助手 欢迎使用WeChat,赶快找好友聊天吧!");
                                //输入框禁用
    ...
    public void FriendInfo(){
        ...
        ((Button) $(mainWindow,"moref")).setOnAction(event -> {
            ...
            if(account.equals("Fly Chat聊天助手"))
            {
                return;
            }
            else {
