                    ...
                    while ((line = in.readUTF()) != null) {
                        ...
                        try {
                            ...
                            if (Msg.equals("###@ ")) {
                                ...
                                if(((Label) mainWindow.$("Y_account")).getText().equals("Fly Chat聊天助手"))
                                {
                                    String msg = I_account+"把你添加为好友,和他聊天吧";
                                    mainWindow.addLeft("system",msg);
                                    MsgData.msg.get(0).add("Fly Chat聊天助手 "+msg);
                                }
                                else
                                {
                                    String msg = I_account+"把你添加为好友,和他聊天吧";
                                    MsgData.msg.get(0).add("Fly Chat聊天助手 "+ msg);
                                    int cnt = MsgData.msgTip.get("Fly Chat聊天助手");
                                    cnt++;
                                    MsgData.msgTip.put("Fly Chat聊天助手", cnt);
