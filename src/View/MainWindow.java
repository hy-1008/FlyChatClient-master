...
public class MainWindow extends window {
    ...
    public MainWindow() throws IOException {
        ...
        Scene scene = new Scene(root, 1085, 700);
...
class ChatListItem{
    ...
    public ChatListItem(){
        ...
        left.setPrefSize(580,50);
        right.setPrefSize(580,50);
...
//        System.out.println("ihead:"+ihead+"itext:"+itext+"width:"+width+"height:"+hight);
        text.getStyleClass().add("lefttext");
        arrow.getStyleClass().add("leftarrow");
        pane.setPrefHeight(30+hight);
...
//        System.out.println("ihead:"+ihead+"itext:"+itext+"width:"+width+"height:"+hight);
        ...
        head.setLayoutY(10);
        head.setLayoutX(525);
        text.setPrefSize(width+2,hight);
        text.setLayoutX(500-width);
        text.setLayoutY(20);
        arrow.setLayoutY(30);
        arrow.setLayoutX(495);
        text.setText(itext);
        MainWindow.setHeadPortrait(head,ihead);
